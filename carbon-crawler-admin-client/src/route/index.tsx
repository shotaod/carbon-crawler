...
import {OAuthLanding} from "../component/page/auth/OAuthLanding";
import {WithSideBar} from "../component/layout";
  ...
  <ConnectedRouter history={props.history}>
    <Switch>
      <LayoutContainer>
        ...
        <Route exact path={path.auth.oauth} component={OAuthLanding}/>
